...
main: 	jal TRACK 		# draw track line
 	addi $a0, $zero, 110 	# Marsbot rotates 90* and start running
 	jal ROTATE
 	jal GO
...
go2: addi $a0, $zero, 162 	# Marsbot rotates 180*
 	jal ROTATE
...
sleep2: addi $v0,$zero,32 	# Keep running by sleeping in 2000 ms
	...
	jal UNTRACK 		# keep old track
 	jal TRACK		# and draw new track line
go3: addi $a0, $zero, 306 	# Marsbot rotates 270* 
 	jal ROTATE
...
go4:	addi $a0, $zero, 90 	# Marsbot rotates 120* 
 	jal ROTATE 
...
go5:	addi $a0, $zero, 234 	# Marsbot rotates 120* 
 	jal ROTATE 
...
go6:	addi $a0, $zero, 18 	# Marsbot rotates 120* 
 	jal ROTATE 
